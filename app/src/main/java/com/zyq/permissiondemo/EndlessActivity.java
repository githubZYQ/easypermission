...
public class EndlessActivity extends BaseActivity {
        ...
        easyPermission = EasyPermission.build()
                ...
                .mResult(new EasyPermissionResult() {
                    ...
                    public boolean onDismissAsk(int requestCode, @NonNull List<String> permissions) {
                        ...
                        easyPermission.openAppDetails(EndlessActivity.this, "Call Phone - Give me the permission to dial the number for you");
                        return true;
                    }
                });
        easyPermission.requestPermission();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (EasyPermission.APP_SETTINGS_RC == requestCode) {
            ...
            if (easyPermission.hasPermission(EndlessActivity.this)) {
                //做你想做的
                textView2.setText("do you something here");
            } else {
                //从设置回来还是没给你权限
